...
#  Класс который будет отвечать за страницу корзины
class CartForAuthenticatedUser:
    ...
    def get_cart_info(self):
        ...
        order, created = Order.objects.get_or_create(customer=customer)  # ССоздаём либо получаем заказ
